    ...
    >
      <defs>
        <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="rgba(255,20,40,0.18)" />
      ...
      <g opacity="0.85" filter="url(#blur)">
        <path
          ...
          strokeWidth="2"
        />
        <circle cx="980" cy="120" r="5" fill="rgba(255,20,40,0.8)" />
        <circle cx="1100" cy="240" r="4" fill="rgba(255,255,255,0.28)" />
        <circle cx="920" cy="410" r="4" fill="rgba(255,20,40,0.55)" />
        ...
        <path
          ...
          strokeWidth="2"
        />
        <circle cx="220" cy="80" r="5" fill="rgba(255,20,40,0.55)" />
        <circle cx="80" cy="240" r="4" fill="rgba(255,255,255,0.22)" />
        <circle cx="120" cy="440" r="4" fill="rgba(255,20,40,0.40)" />

        <path
          d="M560 150h90v110h160v70h120"
          stroke="rgba(255,20,40,0.14)"
          strokeWidth="2"
        />
        <circle cx="560" cy="150" r="4" fill="rgba(255,255,255,0.18)" />
        <circle cx="650" cy="260" r="4" fill="rgba(255,20,40,0.45)" />
        ...
        <path
          ...
          strokeWidth="2"
        />
        <circle cx="520" cy="560" r="4" fill="rgba(255,20,40,0.40)" />
        <circle cx="360" cy="480" r="4" fill="rgba(255,255,255,0.18)" />
        <circle cx="90" cy="410" r="4" fill="rgba(255,20,40,0.33)" />
      </g>
    </svg>
  );
}
