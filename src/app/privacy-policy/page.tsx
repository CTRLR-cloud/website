...
export const metadata: Metadata = {
  ...
  description:
    "This Privacy Policy outlines how CTRL+R handles data and user activity within its decentralized operating infrastructure.",
};

const sections: Array<{ title: string; body: string }> = [
  {
    title: "On-Chain Operations",
    body: "CTRL+R is a blockchain-native platform. All activity, whether related to co-chains, job execution, or governance, is processed on-chain. This means transaction data such as wallet addresses and actions are inherently public and transparent. CTRL+R does not log or store additional metadata outside of this.",
  },
  {
  ...
  },
  {
    ...
    body: "When connecting to CTRL+R, you may use third-party tools like WalletConnect. While CTRL+R does not track or analyze your data, these integrations may use cookies or other technologies for connection purposes. Please refer to those services’ privacy policies for more information.",
  },
  {
  ...
  },
  {
    ...
    body: "The decentralized nature of CTRL+R ensures that all transactions and updates to the network are permanent. Once submitted, data cannot be altered or removed, this is a fundamental principle of blockchain technology.",
  },
  {
  ...
  {
    title: "Get in Touch",
    body: "For inquiries or concerns regarding this Privacy Policy, contact us via: Website: ctrlr.cloud • Telegram: https://t.me/ctrlrportal",
  },
];
...
export default function PrivacyPolicyPage() {
  return (
    <PageShell
      title="Privacy Policy"
      subtitle="This Privacy Policy outlines how CTRL+R handles data and user activity within its decentralized operating infrastructure. Our commitment is to protect user privacy while ensuring transparency across all services and technologies we offer."
    >
