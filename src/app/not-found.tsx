          ...
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="overflow-hidden rounded-[32px] border border-hairline bg-black/35 shadow-glow">
              <div className="relative p-10 md:p-14">
                <div className="pointer-events-none absolute inset-0 opacity-90 bg-[radial-gradient(900px_380px_at_80%_20%,rgba(201,0,7,0.12),transparent_60%),radial-gradient(700px_420px_at_20%_70%,rgba(255,255,255,0.06),transparent_60%)]" />
